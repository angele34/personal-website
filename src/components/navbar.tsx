...
export default function Navbar() {
  return (
    <div className="flex justify-between fixed top-0 w-full z-20 border-b border-[#2d2d2de9]">
      ...
      xl:pl-36
      ">
        <IoCubeOutline size={30} className="cursor-pointer grid ml-8 mr-2 text-white"/>
      ...
      <div className="flex items-center space-x-4 pr-20">
        ...
        <svg width="28px" height="28px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="FFFFFFF">
