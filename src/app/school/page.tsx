...
export default function School() {
    return (
      <div className="relative min-h-screen overflow-hidden flex flex-col 2xl:px-32">
        ...
        >
          ...
          <div className="relative whitespace-normal pt-20 pb-8 pl-40 xxs:px-2 xs:px-8 sm:px-4 md:py-16 md:px-8 lg:px-8 xl:mr-52">
            ...
            <div className="pl-4 pr-8">
              <p className=' text-content-color font-sans_serif font-normal xxs:text-p-xxs xs:text-p-xs sm:text-p-sm md:text-p-md lg:text-p-lg xl:text-p-md 2xl:text-p-xl mb-4 md:mb-6 tracking-wider'>
        ...
        {/* Cards */}
        <div>
          <div className="pt-8 pb-4 px-4 text-content-color-2">
            ...
            <div className="pb-8 text-center">
              <div className="grid gap-2 grid-cols-3 md:grid-cols-2 sm:grid-cols-2 xs:grid-cols-2 sm:text-p-xs">
                ...
                <div className="bg-customGreenLight p-3">
        ...
        <div className="text-content-color text-left pt-8 px-8">
